...
public class Main {
    public static void main(String[] args) {
        ...
        Trip paris = new Trip("Paris", 15000000, "1-MAY-2024", TravelAgent.TripType.FLIGHT, 2);
        Trip newYork = new Trip("New York", 20000000, "15-MAY-2024", TravelAgent.TripType.FLIGHT, 3);
        Trip london = new Trip("London", 18000000, "22-APR-2024", TravelAgent.TripType.HOTEL, 10);
        Trip tokyo = new Trip("Tokyo", 8000000, "25-APR-2024", TravelAgent.TripType.PACKAGE, 7);
        agent.addTrip(paris);
        ...
        System.out.println("-----------------------------------------------------------------------------------------");
        agent.getAvailableTripsByType(TravelAgent.TripType.FLIGHT);
        System.out.println("-----------------------------------------------------------------------------------------");
